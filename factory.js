...
(function (S) {
  ...
  async function produzir(op) {
    ...
    if(S.produtos&&projeto)pedidoVolatil+='\n\nFONTES INTERNAS INTEGRAIS — preserve personagens, cronologia e extensão por capítulo; não inclua estas instruções no produto:\n'+S.produtos.references(e,projeto.id);
